...
parser.add_argument('--full', help='full model', default=False, action='store_true')
...
val_data_loader = DataLoader(ValDataMetaIR(task=task, split='test'), batch_size=val_batch_size, shuffle=False, num_workers=8)
print(f'DataLoader [{len(val_data_loader)}] loaded')
...
val_psnr, val_ssim = validation_val(net, val_data_loader, device, exp_name,category, save_tag=False)
